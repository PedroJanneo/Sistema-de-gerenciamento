...
if ($id ==''){
$res = $pdo->prepare("INSERT INTO emprestimo SET responsavel = :responsavel, telefone = :telefone, item = :item, departamento = :departamento, saida = :saida, situacao = :situacao, situacao2 = :situacao2, secretaria = :secretaria"); // usar 'prepare' pra formulario --> BAnco de dados
        // : parametros (apelido)
...
$res->bindValue(':secretaria',$secretaria);
...
$res = $pdo->prepare("UPDATE emprestimo SET responsavel = :responsavel, telefone = :telefone, item = :item, departamento = :departamento, saida = :saida, devolucao = :devolucao, situacao = :situacao, situacao2 = :situacao2, secretaria = :secretaria, recebido= :recebido WHERE id = :id"); // usar 'prepare' pra formulario --> BAnco de dados
$res->bindValue(":responsavel",$responsavel); // bindValue --> receber variavel e valor diretos
$res->bindValue(":item",$item);
$res->bindValue(":telefone",$telefone);
$res->bindValue(":departamento",$departamento);
