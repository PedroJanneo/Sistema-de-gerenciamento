    ...
    <div class="container ">
        <div class="row justify-content-center text-center">
            <form class="form-signin" method='post' action='autenticar.php'>
                <br>
                <h1 class="h3 mb-3 fw-normal text-center">Acesso | Identifique-se</h1>
                <br>
                ...
                <br>
                <input name="accept" type="submit" value="Entrar" style="background-color: #62a7d0; border-color: #fff;"
                    class="btn btn-block btn-primary w-100 py-2">
            </form>
            <p class="text-center small mt-5"> © 2024</p>
